...
//		LIFO(Last In First Out) 방식 : 기본적인 스택 구조, 입구와 출구가 같은 구조, 마지막에 들어온 내용이 처음으로 나가는 구조
//		FIFO(First In First Out) 방식 : queue의 구조, 입구와 출구가 다른 구조, 처음에 기입되었던 내용이 맨 처음으로 나가는 구조
	}
