 ...
 * buffer라는 문구가 들어오면 임시 공간을 잡아야한다.
 * append 뒤에 붙이겠다 : 원본문자 뒤에 붙인다 == 원본 수정한다.
 * 타입을 변경할 수 있다. 서로 상호 작용이 잘 된다.
 */
public class StringBufferEx1 {
	...
	public static void main(String[] args) {
		...
		StringBuffer sb3 = new StringBuffer("Hello"); // 버퍼의 크기는 문자열 길이만큼 생성됨
		
		//StringBuffer sb4 = "Hello"; 허용하지 않음, x(), String만 가능
...
//		sb2.append('d');
		...
		//deleteCharAT(int index) : index의 문자 제거할 때 사용
